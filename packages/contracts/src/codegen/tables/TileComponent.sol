...
library TileComponent {
  ...
  /** Get tile */
  function get(int32 x, int32 y) internal view returns (TileType tile) {
  ...
  function get(IStore _store, int32 x, int32 y) internal view returns (TileType tile) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((x))));
    _keyTuple[1] = bytes32(uint256(uint32((y))));
  ...
  /** Set tile */
  function set(int32 x, int32 y, TileType tile) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((x))));
    _keyTuple[1] = bytes32(uint256(uint32((y))));
  ...
  function set(IStore _store, int32 x, int32 y, TileType tile) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((x))));
    _keyTuple[1] = bytes32(uint256(uint32((y))));
