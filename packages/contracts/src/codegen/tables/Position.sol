...
library Position {
  ...
  /** Get z */
  function getZ(bytes32 key) internal view returns (uint32 z) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function getZ(IStore _store, bytes32 key) internal view returns (uint32 z) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set z */
  function setZ(bytes32 key, uint32 z) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setZ(IStore _store, bytes32 key, uint32 z) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, int16 x, int16 y, uint32 z) internal {
  ...
  function set(IStore _store, bytes32 key, int16 x, int16 y, uint32 z) internal {
    bytes memory _data = encode(x, y, z);
  ...
  function decode(bytes memory _blob) internal pure returns (PositionData memory _table) {
    ...
    _table.z = (uint32(Bytes.slice4(_blob, 4)));
  }

  /** Tightly pack full data using this table's schema */
  function encode(int16 x, int16 y, uint32 z) internal view returns (bytes memory) {
