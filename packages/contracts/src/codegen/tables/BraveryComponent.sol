...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BraveryComponent")));
bytes32 constant BraveryComponentTableId = _tableId;

library BraveryComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BraveryComponent", _fieldNames);
  }
