...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("GreedComponent")));
bytes32 constant GreedComponentTableId = _tableId;

library GreedComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("GreedComponent", _fieldNames);
  }
