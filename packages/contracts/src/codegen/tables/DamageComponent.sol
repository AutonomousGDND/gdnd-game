...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("DamageComponent")));
bytes32 constant DamageComponentTableId = _tableId;

library DamageComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("DamageComponent", _fieldNames);
  }
